...
const Navbar = () => {
    return (
        <header className='flex justify-between items-center font-[family-name:var(--font-geist-sans)] text-white px-10 border-b-2 border-b-slate-800 overflow-hidden'>
